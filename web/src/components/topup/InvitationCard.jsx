...
const InvitationCard = ({
  ...
  const customDescriptionLines = useMemo(() => {
    ...
    return inviteRewardDescription
      .split('\n')
  ...
  return (
    <Card className='!rounded-2xl shadow-sm border-0'>
      ...
      <Space vertical style={{ width: '100%' }}>
                ...
                <div className='grid grid-cols-3 gap-6 mt-4'>
                  ...
                  <div className='text-center'>
                    <div
                      ...
                      style={{ color: 'white' }}
                    >
                      {inviteeData?.total || userState?.user?.aff_count || 0}
                    </div>
                    <div className='flex items-center justify-center text-sm'>
                      <Users
                        size={14}
        ...
        {/* 返佣等级 + 进度条 */}
        {dashboardData?.commission_enabled && (
          <CommissionTierCard t={t} dashboardData={dashboardData} />
        )}
        ...
        <InviteeListCard
          ...
          onPageChange={onInviteePageChange}
