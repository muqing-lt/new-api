...
import { Modal, Toast, Checkbox, Typography } from '@douyinfe/semi-ui';
...
const TopUp = () => {
  ...
  // 充值协议
  const topupAgreementEnabled =
    statusState?.status?.topup_agreement_enabled || false;
  ...
  const handleCancel = () => {
    setOpen(false);
    setAgreedToTopupAgreement(false);
  };
  ...
  return (
    <div className='w-full max-w-7xl mx-auto relative min-h-screen lg:min-h-0 mt-[60px] px-2'>
      ...
      <PaymentConfirmModal
        ...
        topupAgreementEnabled={topupAgreementEnabled}
      ...
      <Modal
        ...
        confirmLoading={confirmLoading}
        okButtonProps={{
          disabled: topupAgreementEnabled && !agreedToTopupAgreement,
        }}
      >
