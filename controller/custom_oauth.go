...
// GetUserOAuthBindingsByAdmin returns all OAuth bindings for a specific user (admin only)
...
// UnbindCustomOAuthByAdmin unbinds a custom OAuth provider from a user (admin only)
