	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/self/aff/dashboard", controller.GetAffDashboard)
				selfRoute.GET("/self/aff/invitees", controller.GetAffInvitees)
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				// Admin invitation/affiliate management
				adminRoute.GET("/aff/list", controller.AdminGetAffUsers)
				adminRoute.GET("/aff/:id/invitees", controller.AdminGetAffInvitees)
				adminRoute.GET("/aff/:id/records", controller.AdminGetAffRecords)
			}
		}
