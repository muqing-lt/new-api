...
const (
	...
	MsgUserAffCodeInvalidLength      = "user.aff_code_invalid_length"
	MsgUserAffCodeInvalidChars       = "user.aff_code_invalid_chars"
	MsgUserAffCodeAlreadyTaken       = "user.aff_code_already_taken"
	MsgUserAffCodeUpdateSuccess      = "user.aff_code_update_success"
