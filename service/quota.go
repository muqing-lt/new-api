...
func PostConsumeQuotaWithoutAffCommission(relayInfo *relaycommon.RelayInfo, quota int, preConsumedQuota int, sendEmail bool) (err error) {
	return postConsumeQuota(relayInfo, quota, preConsumedQuota, sendEmail, false)
}

func postConsumeQuota(relayInfo *relaycommon.RelayInfo, quota int, preConsumedQuota int, sendEmail bool, enableAffCommission bool) (err error) {
